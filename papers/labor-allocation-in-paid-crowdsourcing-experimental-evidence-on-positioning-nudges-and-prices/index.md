...
```bibtex
@inproceedings{horton2011laborallocationinpaidcrowdsourcingexperimentalevidenceonpositioningnudgesandprices,
  title = {{Labor Allocation in Paid Crowdsourcing: Experimental Evidence on Positioning, Nudges and Prices}},
  author = {Chandler, Dana and Horton, John J.},
  booktitle = {Human Computation: Papers from the 2011 AAAI Workshop},
  year = {2011},
  pages = {14-19},
  url = {https://john-joseph-horton.com/papers/combined_paper_packet.pdf}
}
```
