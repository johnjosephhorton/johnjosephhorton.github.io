...
@unpublished{horton2024buyersignalingimprovesmatchingevidencefromafieldexperiment,
  ...
  year = {2024},
  url = {https://john-joseph-horton.com/papers/buyer-signaling-improves-matching-evidence-from-a-field-experiment/}
}
```

[Google Scholar](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=fhLHgd8AAAAJ&cstart=20&pagesize=80&citation_for_view=fhLHgd8AAAAJ:8AbLer7MMksC)
